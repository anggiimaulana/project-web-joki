            ...
            <div class="mt-6 flow-root">
                <div class="-my-6 divide-y divide-gray-500/10">
                    <div class="space-y-2 py-6">
                        <a href="/"
                            class="-mx-3 flex items-center gap-x-2 rounded-lg px-3 py-2 font-semibold text-gray-900 hover:bg-gray-50 hover:text-sky-500 {{ isset($slug) && $slug === 'home' ? 'active' : '' }}">
                            <i class='bx bxs-home text-xl'></i>
                            <p>Beranda</p>
                        </a>
                        <a href="/app/profil"
                            class="-mx-3 flex items-center gap-x-2 rounded-lg px-3 py-2 font-semibold text-gray-900 hover:bg-gray-50 hover:text-sky-500 {{ isset($slug) && $slug === 'profil' ? 'active' : '' }}">
                            <i class='bx bxl-blogger text-xl'></i>
                            <p>Blog</p>
                        </a>
                        <a href="/app/program"
                            class="-mx-3 flex items-center gap-x-2 rounded-lg px-3 py-2 font-semibold text-gray-900 hover:bg-gray-50 hover:text-sky-500 {{ isset($slug) && $slug === 'program' ? 'active' : '' }}">
                            <i class='bx bx-chart text-xl'></i>
                            <p>Track Order</p>
                        </a>
                        <a href="/app/store"
                            class="-mx-3 flex items-center gap-x-2 rounded-lg px-3 py-2 font-semibold text-gray-900 hover:bg-gray-50 hover:text-sky-500 {{ isset($slug) && $slug === 'store' ? 'active' : '' }}">
                            <i class='bx bxs-star-half text-xl'></i>
                            <p>Review</p>
                        </a>
