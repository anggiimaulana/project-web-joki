<section class="bg-gray-50">
    <div class="container mx-auto py-8 md:py-12">
        ...
        <div class="mt-5 grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 px-4 md:px-0" id="services-list">
            <!-- Berlangganan -->
                ...
                <div class="p-4 text-center text-gray-600">
                    ...
                    <p class="text-base lg:text-xl">
                        ...
                        <span class="text-sky-700 font-bold">
                            JOKIIN<span class="text-sm md:text-base">IT</span>
                        </span>juga menerima pengerjaan tugas di berbagai bidang non-IT, seperti makalah, essay atau karya ilmiah, matematika, analisis, laporan, presentasi, dan lainnya.
                    </p>
                    <div id="hidden-skripsi" class="hidden">
                        <p class="text-base lg:text-xl mt-2 hidden md:block">
                            Kami memahami bahwa tidak semua tugas akademik berkaitan dengan teknologi, sehingga kami berupaya memberikan solusi terbaik bagi Anda yang membutuhkan bantuan di bidang lain.
                        </p>
                        <p class="text-base lg:text-xl mt-2">
                            Layanan ini tersedia berdasarkan kesanggupan worker, dan harga akan disesuaikan dengan tingkat kesulitan serta kompleksitas tugas. 
                            Jika worker tidak dapat mengerjakannya, maka tugas tersebut tidak bisa kami proses. Jadi, pastikan untuk menghubungi kami terlebih dahulu untuk memastikan ketersediaan! 😊
                        </p>
                    </div>
